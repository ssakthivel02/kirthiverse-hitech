(()=>{
  ...
  window.KV_APP_RUNTIME={candidate:CANDIDATE,version:'v23',navigation:'central-delegated',renderLifecycle:'authoritative-app-render',legacyPerLinkHandlers:false,legacyAgeHandlers:false,practiceArena:'v1-local-only'};
