/* KirthiVerse P0 entry points v9 — core funding-readiness extensions + controlled Class 6 curriculum pilots.
   ...
   Migration note: previous Science generation CBSE6-SCI-CH7-1 used lazy lesson range ch(?:4|5|6|7). */
(()=>{
  ...
  const upperScienceAssessments=[['class6-science-ch3-assessments','data/class6-science-ch3-assessments.js'],['class6-science-ch4-assessments','data/class6-science-ch4-assessments.js'],['class6-science-ch5-assessments','data/class6-science-ch5-assessments.js'],['class6-science-ch6-assessments','data/class6-science-ch6-assessments.js'],['class6-science-ch7-assessments','data/class6-science-ch7-assessments.js'],['class6-science-ch8-assessments','data/class6-science-ch8-assessments.js']];
  ...
  const scienceBaseFiles=()=>[
    ...
    ['class6-science-ch2-lessons','data/class6-science-ch2.js'],['class6-science-ch2-assessments','data/class6-science-ch2-assessments.js'],
    ['class6-science-ch3-lessons','data/class6-science-ch3.js'],
    ['class6-science-ch4-lessons','data/class6-science-ch4.js'],
    ['class6-science-ch5-lessons','data/class6-science-ch5.js'],['class6-science-ch6-lessons','data/class6-science-ch6.js'],['class6-science-ch7-lessons','data/class6-science-ch7.js'],['class6-science-ch8-lessons','data/class6-science-ch8.js'],
    ...(needsAllScienceAssessments()?upperScienceAssessments:[])
  ];
  const loadClass6SciencePilot=()=>loadCurriculumPilot({datasetKey:'class6SciencePilot',subject:'Science',version:'CBSE6-SCI-CH8-2',files:scienceBaseFiles()});
  let upperScienceLoadStarted=false;
  function needsUpperScienceAssessments(){
    const p=location.pathname;
    return needsAllScienceAssessments()||/^\/lesson\/science\.cbse6\.curiosity\.ch(?:3|4|5|6|7|8)\./.test(p)||['/practice','/practice-arena','/diagnostic'].includes(p);
  }
  function loadUpperScienceAssessments(){
    ...
    loadCurriculumPilot({datasetKey:'class6ScienceUpperAssessments',subject:'Science',version:'CBSE6-SCI-CH8-2-A',files:upperScienceAssessments});
  }
  ...
  addEventListener('popstate',loadUpperScienceAssessments);
  addEventListener('kv:rendered',()=>{loadUpperScienceAssessments();addNavLinks();addHomePanel()});
  addNavLinks();addHomePanel();loadUpperScienceAssessments();
})();