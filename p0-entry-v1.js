/* KirthiVerse P0 entry points v9 — core funding-readiness extensions + controlled Class 6 curriculum pilots.
   ...
   Migration history: CBSE6-SCI-CH7-1 used lazy ch(?:4|5|6|7); CBSE6-SCI-CH8-2 used lazy ch(?:3|4|5|6|7|8). */
(()=>{
  ...
  function loadDeferredScienceAssessments(){
    ...
    loadCurriculumPilot({datasetKey:'class6ScienceDeferredAssessments',subject:'Science',version:'CBSE6-SCI-CH9-1-A',files:deferredScienceAssessments});
  }
