...
(()=>{
  ...
  const upperScienceAssessments=[['class6-science-ch4-assessments','data/class6-science-ch4-assessments.js'],['class6-science-ch5-assessments','data/class6-science-ch5-assessments.js'],['class6-science-ch6-assessments','data/class6-science-ch6-assessments.js'],['class6-science-ch7-assessments','data/class6-science-ch7-assessments.js'],['class6-science-ch8-assessments','data/class6-science-ch8-assessments.js']];
  ...
  const scienceBaseFiles=()=>[
    ...
    ['class6-science-ch3-lessons','data/class6-science-ch3.js'],['class6-science-ch3-assessments','data/class6-science-ch3-assessments.js'],
  ...
  const loadClass6SciencePilot=()=>loadCurriculumPilot({datasetKey:'class6SciencePilot',subject:'Science',version:'CBSE6-SCI-CH8-1',files:scienceBaseFiles()});
  let upperScienceLoadStarted=false;
  function needsUpperScienceAssessments(){
    const p=location.pathname;
    return needsAllScienceAssessments()||/^\/lesson\/science\.cbse6\.curiosity\.ch(?:4|5|6|7|8)\./.test(p)||['/practice','/practice-arena','/diagnostic'].includes(p);
  }
  function loadUpperScienceAssessments(){
    ...
    loadCurriculumPilot({datasetKey:'class6ScienceUpperAssessments',subject:'Science',version:'CBSE6-SCI-CH8-1-A',files:upperScienceAssessments});
  }
