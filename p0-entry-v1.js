...
(()=>{
  ...
  const upperScienceAssessments=[['class6-science-ch5-assessments','data/class6-science-ch5-assessments.js'],['class6-science-ch6-assessments','data/class6-science-ch6-assessments.js']];
  ...
  const scienceBaseFiles=()=>[
    ...
    ['class6-science-ch4-lessons','data/class6-science-ch4.js'],['class6-science-ch4-assessments','data/class6-science-ch4-assessments.js'],
  ...
  function needsUpperScienceAssessments(){
    ...
    return needsAllScienceAssessments()||/^\/lesson\/science\.cbse6\.curiosity\.ch(?:5|6)\./.test(p)||['/practice','/practice-arena','/diagnostic'].includes(p);
  }
