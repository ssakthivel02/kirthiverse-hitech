...
(()=>{
  ...
  const scienceBaseFiles=()=>[
    ...
    ['class6-science-ch5-lessons','data/class6-science-ch5.js'],['class6-science-ch6-lessons','data/class6-science-ch6.js'],['class6-science-ch7-lessons','data/class6-science-ch7.js'],
    ...(needsAllScienceAssessments()?upperScienceAssessments:[])
  ];
  const loadClass6SciencePilot=()=>loadCurriculumPilot({datasetKey:'class6SciencePilot',subject:'Science',version:'CBSE6-SCI-CH7-1',files:scienceBaseFiles()});
  let upperScienceLoadStarted=false;
  function needsUpperScienceAssessments(){
    const p=location.pathname;
    return needsAllScienceAssessments()||/^\/lesson\/science\.cbse6\.curiosity\.ch(?:4|5|6|7)\./.test(p)||['/practice','/practice-arena','/diagnostic'].includes(p);
  }
  function loadUpperScienceAssessments(){
    ...
    loadCurriculumPilot({datasetKey:'class6ScienceUpperAssessments',subject:'Science',version:'CBSE6-SCI-CH7-1-A',files:upperScienceAssessments});
  }
