...
(()=>{
  ...
  const mathBaseFiles=()=>[
    ...
    ['class6-math-ch3-4-lessons','data/class6-math-ch3-4-runtime.js'],
    ...(needsReleaseClosure()?deferredMathAssessments:[])
  ];
  const loadClass6MathPilot=()=>loadCurriculumPilot({datasetKey:'class6MathPilot',subject:'Mathematics',version:'CBSE6-MATH-CH4-1',files:mathBaseFiles()});
  let deferredMathLoadStarted=false;
  function needsDeferredMathAssessments(){
    const p=location.pathname;
    return needsReleaseClosure()||/^\/lesson\/math\.cbse6\.ganita-prakash\.(?:patterns\.|ch(?:2|3|4)\.)/.test(p)||['/practice','/practice-arena','/diagnostic'].includes(p);
  }
  function loadDeferredMathAssessments(){
    ...
    loadCurriculumPilot({datasetKey:'class6MathDeferredAssessments',subject:'Mathematics',version:'CBSE6-MATH-CH4-1-A',files:deferredMathAssessments});
  }
