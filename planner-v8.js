(()=>{
  ...
  function bind(){document.querySelectorAll('[data-goal-v8]').forEach(b=>b.onclick=()=>setGoal(Number(b.dataset.goalV8)));document.querySelectorAll('[data-pref-v8]').forEach(b=>b.onclick=()=>togglePref(b.dataset.prefV8));}
