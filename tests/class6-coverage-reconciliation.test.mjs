...
assert.equal(manifest.pilot.lastReconciledMain,'b3334ddbbbb259cb2d0b08bb8e9bda517b3a8db5');
...
assert.equal(social.status,'CHAPTERS_1_2_3_4_5_6_7_IMPLEMENTED_AND_SCHOOL_NEEDS_VALIDATED');
