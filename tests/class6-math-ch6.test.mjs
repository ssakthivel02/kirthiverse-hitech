...
for(const asset of ['data/class6-math-ch3-4-runtime.js','data/class6-math-ch6-assessments.js','data/class6-math-ch7-assessments.js','data/class6-math-ch8-assessments.js','data/class6-math-ch9-assessments.js','data/class6-math-ch10-assessments.js'])assert.ok(entry.includes(asset),`loader missing ${asset}`);
assert.ok(entry.includes('ch(?:2|3|4|5|6|7|8|9|10)\\.'),'Chapter 1-10 deferred-assessment route coverage missing');assert.ok(!entry.includes("/^\\/lesson\\/math\\./"));
const baseChunk=entry.slice(entry.indexOf('const mathBaseFiles'),entry.indexOf('const loadClass6MathPilot'));
assert.ok(baseChunk.includes('data/class6-math-ch3-4-runtime.js'));assert.ok(!baseChunk.includes('data/class6-math-ch6.js'));assert.ok(!baseChunk.includes('data/class6-math-ch7.js'));assert.ok(!baseChunk.includes('data/class6-math-ch8.js'));assert.ok(!baseChunk.includes('data/class6-math-ch9.js'));assert.ok(!baseChunk.includes('data/class6-math-ch10.js'));assert.ok(!baseChunk.includes('data/class6-math-ch6-assessments.js'));assert.ok(!baseChunk.includes('data/class6-math-ch7-assessments.js'));assert.ok(!baseChunk.includes('data/class6-math-ch8-assessments.js'));assert.ok(!baseChunk.includes('data/class6-math-ch9-assessments.js'));assert.ok(!baseChunk.includes('data/class6-math-ch10-assessments.js'));
const sw=fs.readFileSync('sw-v30.js','utf8');assert.match(sw,/kirthiverse-preview-v45/);for(const asset of ['/data/class6-math-ch3-4-runtime.js','/data/class6-math-ch6-assessments.js','/data/class6-math-ch7-assessments.js','/data/class6-math-ch8-assessments.js','/data/class6-math-ch9-assessments.js','/data/class6-math-ch10-assessments.js'])assert.ok(sw.includes(asset));
