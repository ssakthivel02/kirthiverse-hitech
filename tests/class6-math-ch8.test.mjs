...
for(const asset of ['data/class6-math-ch2.js','data/class6-math-ch3-4-runtime.js','data/class6-math-ch8-assessments.js','data/class6-math-ch9-assessments.js','data/class6-math-ch10-assessments.js']) assert.ok(entry.includes(asset),`loader missing ${asset}`);
...
for(const asset of ['/data/class6-math-ch2.js','/data/class6-math-ch3-4-runtime.js','/data/class6-math-ch8-assessments.js','/data/class6-math-ch9-assessments.js','/data/class6-math-ch10-assessments.js']) assert.ok(sw.includes(asset),`precache missing ${asset}`);
