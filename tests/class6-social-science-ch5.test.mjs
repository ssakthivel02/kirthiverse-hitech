...
assert.equal(map.schemaVersion,'1.15.0');assert.equal(ch5.status,'KIKI_TEACHING_SLICE_COMPLETE');assert.equal(ch5.topicCount,4);assert.equal(ch5.assessmentCount,20);
