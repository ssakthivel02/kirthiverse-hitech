...
(()=>{
  ...
  normalizeShell();
  window.KV_VISUAL_MASTER={candidate:C,version:'v27',source:'owner-provided Manus current-state handover',manusRuntime:false,shellIdentity:'visual-master',routeFocusManaged:true,initialLoadFocusPreserved:true,focusAfterSpaNavigation:true,pendingAssets:['kirthiverse-mark_28bda5f0.png','kirthiverse-hero_15ccac10.png','kirthiverse-worlds_d4d17287.png']};
  window.KV_VISUAL_PAGES={candidate:C,version:'v27',profileNavUsesDataLink:true,routeDataset:true,routeFocusManaged:true,initialLoadFocusPreserved:true,localOnly:true,manusRuntime:false};
})();
